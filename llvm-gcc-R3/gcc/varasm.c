...
void
assemble_tm_wrapper (tree def, tree wrapper)
{
  /* LLVM LOCAL begin */
#ifdef ENABLE_LLVM
  emit_tm_wrapper_llvm(def, wrapper);
#endif
  /* LLVM LOCAL end */
}

void
assemble_tm_pure (tree def)
{
  /* LLVM LOCAL begin */
#ifdef ENABLE_LLVM
  emit_tm_pure_llvm(def);
#endif
  /* LLVM LOCAL end */
}

void
assemble_tm_callable (tree def)
{
  /* LLVM LOCAL begin */
#ifdef ENABLE_LLVM
  emit_tm_callable_llvm(def);
#endif
  /* LLVM LOCAL end */
}
