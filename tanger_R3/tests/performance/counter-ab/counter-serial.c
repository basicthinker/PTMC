/*
 * Two threads concurrently update a shared counter. However, we
 * force them to go to serial mode in each transaction.
 */

/* Copyright (C) 2008-2009  Pascal Felber, Diogo Becker de Brum
 *
