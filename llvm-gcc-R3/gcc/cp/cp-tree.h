...
extern tree begin_tm_atomic			(void);
extern void build_tm_atomic_block               (tree);
extern void finish_tm_atomic			(tree);
extern tree finish_tm_atomic_abort		(void);
/* in cp-gimplify.c */
extern void gimplify_cpp_tm_atomic              (tree *);
